...
('Les Ombres du Passé', 'Un voyage aventureux à travers des secrets oubliés.', 'assets/img/les_ombres_du_passe.webp', 115, FALSE, 12, '2025-12-17', 'active', 4.2),                   -- Film example 1
('Échos de la Ville', 'Une course effrénée mêlant action et suspense urbain.', 'assets/img/echos_de_la_ville.webp', 105, FALSE, 16, '2025-12-17', 'active', 3.9),                     -- Film example 2
('Murmures dans la Forêt', 'Une histoire de peur et de survie dans un environnement hostile.', 'assets/img/murmures_dans_la_foret.webp', 95, FALSE, 18, '2025-12-17', 'active', 4.5), -- Film example 3
...
('2026-01-14 10:00:00', 'ended', NULL, 1, 1, 1),
('2026-01-15 13:00:00', 'ended', NULL, 3, 1, 3),
('2026-01-17 16:00:00', 'ended', NULL, 5, 1, 6),
('2026-01-18 19:30:00', 'active', NULL, 7, 1, 8),

-- FILM 2 - Shown in: Nantes (1), Bordeaux (2), Toulouse (4), Lille (5), Liège (7)
('2026-01-21 11:00:00', 'active', NULL, 2, 2, 2),
('2026-01-22 14:30:00', 'active', NULL, 4, 2, 5),
('2026-01-23 17:30:00', 'active', NULL, 5, 2, 6),
('2026-01-24 20:00:00', 'active', NULL, 7, 2, 8),

-- FILM 3 - Shown in: Nantes (1), Paris (3), Charleroi (6)
('2026-01-21 10:30:00', 'active', NULL, 3, 3, 3),
('2026-01-22 13:00:00', 'active', NULL, 1, 3, 1),
('2026-01-24 15:30:00', 'active', NULL, 6, 3, 7),
('2026-01-25 18:30:00', 'active', NULL, 6, 3, 7),

-- FILM 4 - Shown in: Bordeaux (2), Paris (3), Lille (5), Charleroi (6), Liège (7)
('2026-01-25 10:00:00', 'active', NULL, 2, 4, 2),
('2026-01-27 13:00:00', 'active', NULL, 3, 4, 3),
('2026-01-28 16:00:00', 'active', NULL, 5, 4, 6),
('2026-12-29 19:00:00', 'active', NULL, 7, 4, 8),

-- FI6M 5 - Shown in: Bordeaux (2), Paris (3), Lille (5)
('2026-01-16 11:00:00', 'ended', NULL, 2, 5, 2),
('2026-01-17 14:00:00', 'ended', NULL, 3, 5, 3),
('2026-01-18 17:00:00', 'active', NULL, 5, 5, 6),
('2026-01-20 20:00:00', 'active', NULL, 3, 5, 4),

-- FILM 6 - Shown in: Bordeaux (2), Toulouse (4), Charleroi (6)
('2026-01-16 12:00:00', 'ended', NULL, 2, 6, 2),
('2026-01-17 15:00:00', 'ended', NULL, 4, 6, 5),
('2026-01-21 18:00:00', 'active', NULL, 6, 6, 7),
('2026-01-22 20:30:00', 'active', NULL, 6, 6, 7),

-- FILM 7 - Shown in: Nantes (1), Toulouse (4), Charleroi (6)
('2026-01-16 13:00:00', 'ended', NULL, 1, 7, 1),
('2026-01-17 16:00:00', 'ended', NULL, 4, 7, 5),
('2026-01-18 19:30:00', 'active', NULL, 6, 7, 7),
('2026-01-20 10:30:00', 'active', NULL, 1, 7, 1),

-- FILM 8 - Shown in: Toulouse (4), Liège (7)
('2026-01-16 10:00:00', 'ended', NULL, 4, 8, 5),
('2026-01-17 13:00:00', 'ended', NULL, 7, 8, 8),
('2026-01-22 16:00:00', 'active', NULL, 4, 8, 5),
('2026-01-24 19:00:00', 'active', NULL, 7, 8, 8);
